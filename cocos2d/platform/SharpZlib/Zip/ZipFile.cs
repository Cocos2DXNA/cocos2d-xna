...
using Cocos2D.Compression.ICSharpCode.SharpZipLib.Encryption;
#endif

using Cocos2D.Compression.ICSharpCode.SharpZipLib.Core;
using Cocos2D.Compression.ICSharpCode.SharpZipLib.Checksums;
using Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.Compression;

namespace Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.ZipException">
