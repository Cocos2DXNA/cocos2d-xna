...
namespace Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="Cocos2D.Compression.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
