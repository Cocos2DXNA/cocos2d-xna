...
namespace Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipEntry // : ICloneable
	{
		...
		/// </returns>
		/// <see cref="Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated"/>
		/// <see cref="Cocos2D.Compression.ICSharpCode.SharpZipLib.Zip.CompressionMethod.Stored"/>
