...
namespace Box2D.TestBed.Tests
{
    public class Breakable : Test
    {
        ...
        public void Break()
        {
            ...
            b2Vec2 velocity1 = m_velocity + b2Math.b2Cross(m_angularVelocity, center1 - center);
            b2Vec2 velocity2 = m_velocity + b2Math.b2Cross(m_angularVelocity, center2 - center);
